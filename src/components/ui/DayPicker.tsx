...
const classNames: DayPickerDefaultProps["classNames"] = {
  ...
  day: "rounded-full w-10 h-10 transition-colors hover:bg-slate-100 focus:outline-none focus-visible:ring focus-visible:ring-slate-300 focus-visible:ring-opacity-50 active:bg-slate-600 active:text-white",
  day_selected: "text-white bg-slate-800 hover:bg-slate-800",
  day_today: "font-bold",
  day_disabled:
...
) => <OriDayPicker weekStartsOn={1} classNames={classNames} {...props} />;
